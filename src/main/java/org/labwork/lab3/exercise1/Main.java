...
//import org.Lab2.example_two.FitnessFunctionTaylor;
...
public class Main {
    ...
    public static void main(String[] args) throws
        ...
        dataset.addSeries(yRefSeries); // Sine wave
        ...
        for (int i = 0; i < MAX_ALLOWED_EVOLUTIONS; i++) {
            ...
            double[] yEst = FitnessFunctionTrajectory.GetY(FitnessFunctionTrajectory.Mapping(bestChrSoFar));
            ...
            System.out.println(
                    "Fitness: " + currentFitness + ", " +
                            "individual: " + FitnessFunctionTrajectory.toString(bestChrSoFar) + ", Y value: " + Arrays.toString(yEst));
